package club.pineclone.gui.functionalPanel;
...
public class LaunchPanel extends JFrame {
    /**
     * A LaunchPanelCtx contains the logic of how those button in the main frame display to the client, while execute different
     ...
     */
    private final LaunchPanelCtx ctx;
    ...
    private class MenuBarListener implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent e) {
            if (e.getPropertyName().equals("language_change")) {
                ...
                settingMenu.setText(LocaleUtils.loc(LocTag.SETTING));
    ...
    public LaunchPanel() throws AWTException {
        ...
        this.ctx = new LaunchPanelCtx(this);
