...
public class MainFrame extends JFrame {
    /**
     * A LaunchContext contains the logic of how those button in the main frame display to the client, while execute different
    ...
    private class ButtonListener implements PropertyChangeListener {
    ...
    public MainFrame() throws AWTException {
        ...
        this.ctx = new LaunchContext(this);
        ...
        keyboard.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JDialog basicDialog = new JDialog(MainFrame.this,
                ...
                resetBeginRecordBut.addActionListener(el -> {
                    JDialog resetDialog = KeyUtils.getSetHotkeyDialog(MainFrame.this,
                ...
                basicDialog.pack();
                basicDialog.setLocation(GuiUtils.getRelativeCenter(basicDialog, MainFrame.this));
        ...
        setStartDelay.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                CompletableFuture.runAsync(() -> {
                    ...
                    dialog.pack();
                    Point point = GuiUtils.getRelativeCenter(dialog, MainFrame.this);
...
//        outputPanel.setBorder(BorderFactory.createLineBorder(Color.GRAY));
        ...
        /* for event */
        dispatcher.subscribe(MenuBarListener::new);
        dispatcher.subscribe(ButtonListener::new);
        dispatcher.subscribe(ExtendListener::new);
